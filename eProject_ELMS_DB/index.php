...
<body>
  ...
  <header class="nav">
    ...
    <div class="nav-right">
      <button class="btn ghost"  onclick="location.href='login.php'"><i class="fa-solid fa-right-to-bracket"></i> Log in</button>
      <button class="btn primary" onclick="location.href='register_account.php'"><i class="fa-solid fa-user-plus"></i> Sign Up</button>
    </div>
  </header>
  ...
  <footer class="site-footer">
    <div class="footer-columns">
      ...
      <div class="footer-col">
        ...
        <ul>
          ...
          <li><a href="https://www.w3schools.com/python/module_random.asp">Python Reference</a></li>
          <li><a href="https://www.w3schools.com/php/php_ref_overview.asp">PHP Reference</a></li>
        </ul>
      </div>
      <div class="footer-col">
        <h4>Top Examples</h4>
        <ul>
          ...
          <li><a href="https://www.w3schools.com/css/css_templates.asp">CSS Examples</a></li>
          <li><a href="https://www.w3schools.com/js/js_examples.asp">JS Examples</a></li>
          ...
          <li><a href="https://www.w3schools.com/php/php_ref_overview.asp">PHP Examples</a></li>
        </ul>
      </div>
      <div class="footer-col">
        <h4>Get Certified</h4>
    ...
    <div class="footer-bottom">
      ...
      <div class="counter">
        <i class="fa-solid fa-eye"></i> Visits: <strong><?php echo number_format($visits); ?></strong>
      </div>
    </div>
